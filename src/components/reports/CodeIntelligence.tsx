      ...
      <CardContent className="space-y-5">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <section className="rounded-lg border bg-muted/20 p-4">
            ...
            <div className="space-y-2">
              {areas.map(([area, files]) => <div key={area} className="flex items-center justify-between gap-3 text-xs"><span className="font-medium">{area}</span><Badge variant="outline">{files.length} files</Badge></div>)}
            </div>
        ...
        <section className="rounded-lg border bg-muted/20 p-4">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            <Metric label="Large files" value={data.quality.largeFiles.length} />
            <Metric label="Large functions" value={data.quality.largeFunctions.length} />
            <Metric label="TODO" value={data.quality.todoCount} />
            <Metric label="FIXME" value={data.quality.fixmeCount} />
          </div>
