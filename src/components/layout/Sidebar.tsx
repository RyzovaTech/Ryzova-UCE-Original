...
import { LayoutDashboard, CloudUpload as UploadCloud, ChartBar as FileBarChart, CreditCard, Settings } from 'lucide-react';
    ...
    <aside className="hidden w-60 flex-col border-r bg-card md:flex">
      ...
      <div className="border-t p-4">
        <div className="rounded-md border bg-gradient-to-br from-primary/10 to-secondary/10 p-3">
          <p className="text-xs font-medium">UCE v1.0.0</p>
