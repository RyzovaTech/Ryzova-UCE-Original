...
const problems = [
  {
    ...
    desc: "Mismatched runtimes and packages break builds silently.",
  },
  {
    icon: Package,
    title: "Missing dependencies",
    desc: "Unlisted or unpinned packages cause non-deterministic installs.",
  },
  {
    icon: Terminal,
    title: "Environment problems",
    desc: "Missing env vars and config drift between local and CI.",
  },
  {
    icon: Bug,
    title: "Runtime issues",
    desc: "EOL runtimes and outdated majors introduce security and build risk.",
  },
];
...
const features = [
  {
    ...
    desc: "Analyze a public GitHub repository or ZIP archive without changing your workflow.",
  },
  {
    icon: ShieldCheck,
    title: "Compatibility Detection",
    desc: "Deterministic rules flag runtime, dependency, and config risk.",
  },
  {
    icon: Zap,
    title: "Runtime Insights",
    desc: "See the detected runtime, language, and build tool at a glance.",
  },
  {
    icon: Layers,
    title: "Dependency Awareness",
    desc: "Spot outdated majors, missing lockfiles, and duplicate ranges.",
  },
  {
    icon: CheckCircle2,
    title: "Clear Reports",
    desc: "Engineering-grade reports with severity, impact, and next steps.",
  },
  {
    icon: Terminal,
    title: "Developer Friendly",
    desc: "Built for engineers — no marketing fluff, no AI claims.",
  },
];
...
const steps = [
  {
    ...
    desc: "Upload a ZIP archive or paste a public GitHub repository URL.",
  },
  {
    step: 2,
    title: "UCE Analyzes Structure",
    desc: "Files are scanned and the stack is detected deterministically.",
  },
  {
    step: 3,
    title: "Receive Compatibility Report",
    desc: "Get a scored report with issues and recommendations.",
  },
];
...
const audience = [
  ...
  { icon: Zap, title: "Indie Hackers", desc: "Ship faster by fixing compatibility before deploy." },
  {
    ...
    desc: "Standardize project health across repositories.",
  },
  {
    icon: GitBranch,
    title: "Open Source Maintainers",
    desc: "Give contributors a clear compatibility baseline.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b">
        ...
        <div
          className="absolute left-1/2 top-0 -z-0 h-[480px] w-[680px] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"
          aria-hidden
        />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                Understand software compatibility before debugging. No AI. Local-first analysis runs
                in your browser.
              </p>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div
                className="absolute inset-0 -z-0 rounded-2xl bg-gradient-to-br from-primary/10 via-secondary/10 to-transparent blur-2xl"
                aria-hidden
              />
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-success">
                        81<span className="text-sm font-normal text-muted-foreground">/100</span>
                      </p>
                    </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Developers waste hours fixing issues that a deterministic check could catch in
              seconds.
            </p>
            <div className="mt-6 grid gap-3">
              {problems.map((p) => {
                ...
                return (
                  <div
                    key={p.title}
                    className="flex items-start gap-3 rounded-lg border bg-card p-4 transition-colors hover:border-destructive/30"
                  >
          ...
          <div>
            <Badge variant="outline" className="mb-3 border-success/30 text-success">
              The Solution
            </Badge>
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
              Engineering reports, not guesses
            </h2>
            <p className="mt-3 text-muted-foreground">
              Analyze a ZIP archive or Git repository and receive an engineering compatibility
              report.
            </p>
            <Card className="mt-6 border-primary/20 bg-primary/10">
              <CardHeader>
                ...
                <CardDescription>
                  A deterministic engine inspects your project and returns a scored report — no
                  magic, no AI.
                </CardDescription>
              </CardHeader>
      ...
      <section className="border-y bg-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-16 md:px-8 md:py-24">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
              Everything you need to inspect a project
            </h2>
            <p className="mt-3 text-muted-foreground">Before it blocks you.</p>
          </div>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => {
              ...
              return (
                <Card
                  key={f.title}
                  className="transition-all duration-200 hover:border-primary/40 hover:shadow-soft hover:-translate-y-0.5"
                >
                  <CardHeader>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:px-8 md:py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
            Three steps from project to report
          </h2>
        </div>
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <Button variant="outline" asChild className="gap-2">
            <a
              ...
              aria-label="Official Ryzova UCE repository on GitHub"
            >
      ...
      <section className="relative overflow-hidden border-t bg-primary text-primary-foreground">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-start gap-6 px-4 py-14 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
              Find compatibility issues before they become debugging nightmares.
            </h2>
            <p className="mt-2 text-primary-foreground/90">
              Analyze a ZIP archive or Git repository and get a deterministic report in seconds.
            </p>
          </div>
          <Button
            size="lg"
